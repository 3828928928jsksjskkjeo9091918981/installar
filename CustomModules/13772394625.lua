...
runFunction(function()
	local parrythingidk = GuiLibrary.ObjectsThatCanBeSaved.ExploitWindow.Api.CreateOptionsButton({
		Name = "AutoParry",
		Function = function(calling)
			if calling then
				...
				local d = loadstring(game:HttpGet("https://raw.githubusercontent.com/galaxyvape/a/refs/heads/main/thing.lua"))()
